        ...
        <TabsContent value="analytics" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>View detailed analytics about your application.</CardDescription>
            </CardHeader>
        ...
        <TabsContent value="reports" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Generate and view reports about your application.</CardDescription>
            </CardHeader>
            <CardContent className="h-[400px] flex items-center justify-center text-muted-foreground">
